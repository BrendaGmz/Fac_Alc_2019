...
Public Declare Function CMS_QuerySigData Lib "diCrPKI.dll" _
    (ByVal strDataOut As String, ByVal nDataLen As Long, _
    ByVal strFileIn As String, ByVal strQuery As String, _
    ByVal nOptions As Long) As Long
    
Public Declare Function CMS_VerifySigData Lib "diCrPKI.dll" _
    (ByVal strFileIn As String, ByVal strCertFile As String, _
...
' New in Version 2.8...
Public Declare Function X509_GetCertFromP7Chain Lib "diCrPKI.dll" _
    (ByVal strOutputFile As String, ByVal strP7cFile As String, _
    ByVal nIndex As Long, ByVal nOptions As Long) As Long

Public Declare Function X509_GetCertFromPFX Lib "diCrPKI.dll" _
    (ByVal strOutputFile As String, ByVal strPfxFile As String, _
    ByVal strReserved As String, ByVal nOptions As Long) As Long

Public Declare Function X509_ReadStringFromFile Lib "diCrPKI.dll" _
    (ByVal strOutput As String, ByVal nOutChars As Long, _
    ByVal strCertFile As String, ByVal nOptions As Long) As Long
...
'.NET CRYPTOSYS
'*************************************************
Public Declare Function Net_Certificado_No_Serie Lib "Factura_Electronica_Metodos.dll" _
    (ByVal Ruta_Certificado As String) As String
Public Declare Function Net_Certificado_No_Certificado Lib "Factura_Electronica_Metodos.dll" _
    (ByVal Ruta_Certificado As String) As String
Public Declare Function Net_Convierte_Latin1_A_UTF8 Lib "Factura_Electronica_Metodos.dll" _
    (ByVal Cadena_A_Convertir As String) As String
Public Declare Function Net_Sello_Digital Lib "Factura_Electronica_Metodos.dll" _
    (ByVal Ruta_Archivo_UTF8 As String, ByVal Ruta_Llave_Privada As String, ByVal Password_Llave As String) As String
